...
class TestCritic:
    ...
    def test_evaluation_should_build_prompt_and_delegate_to_session_and_pass(self, tmp_path):
    ...
    def test_evaluation_should_include_distinct_evidence_source_in_prompt_and_pass(self, dummy_path, dummy_characteristic, tmp_path):
    ...
    def test_evaluation_should_give_distinct_working_dir_to_session_and_pass(self, dummy_path, dummy_characteristic, tmp_path):
    ...
    def test_evaluation_should_list_every_failed_row_on_failure(self, dummy_path):
        session_stub = MagicMock(spec=ClaudeSession)
    ...
    def test_evaluation_should_tolerate_prose_before_json_and_pass(self, dummy_path, dummy_characteristic):
        prose_then_json = (
    ...
    def test_evaluation_should_tolerate_code_fenced_json_and_pass(self, dummy_path, dummy_characteristic):
        markdown = '```json\n[{"characteristic": "any", "status": "PASS"}]\n```\n'
        session_stub = MagicMock(spec=ClaudeSession)
    ...
    def test_evaluation_should_tolerate_prose_before_fenced_json_and_pass(self, dummy_path, dummy_characteristic):
        prose_then_fence = (
