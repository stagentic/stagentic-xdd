...
class TestClaudeCli:
    def test_should_submit_full_command_to_subprocess(self, tmp_path):
    ...
    def test_should_return_stdout_when_subprocess_succeeds(self):
    ...
    def test_should_omit_session_id_from_command_when_not_provided(self):
        subprocess = MagicMock(side_effect=StubbedSubprocess(returncode=0))
    ...
    def test_should_omit_workspace_from_command_when_not_provided(self):
        subprocess = MagicMock(side_effect=StubbedSubprocess(returncode=0))
    ...
    def test_should_pass_the_prompt_to_subprocess(self):
        subprocess = MagicMock(side_effect=StubbedSubprocess(returncode=0))
    ...
    def test_should_pass_the_session_id_to_subprocess(self):
        subprocess = MagicMock(side_effect=StubbedSubprocess(returncode=0))
